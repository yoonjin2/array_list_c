...
list_int push_inter(list_int X)
{
...
list_int change_inter(list_int X)
{
    int x,y,sv;
    scanf("%d %d", &x, &y);
    sv=X.list[x];
...
list_int list_remove_inter(list_int X)
{
    int Y;
    scanf("%d",&Y);
